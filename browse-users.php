...
<meta http-equiv="refresh" content="5">
	...
	<title>THEBEST ONE MAP UPDATE & search and pagination</title>
...
<body>
	...
	<div class="bg-light border-bottom shadow-sm sticky-top">
		<div class="container">
			<header class="blog-header py-1">
				<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand text-muted p-0 m-0" href="misv2.thebest1.co.th">
				<img src='images/logo.png' width='50'  alt='thebest_one_map'></a>
					<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
					 aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-17" class="active nav-item"><a title="Home" href="http://misv2.thebest1.co.th/" class="nav-link">Home</a></li>
							<!-- 
	...
	?>
   	<div class="container">
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-4-with-search-functionality/">THEBEST ONE MAP UPDATE & search and pagination</a></h1>
		<div class="card">
				...
				<div class="col-sm-12">
					...
					<form method="get">
						<div class="row">
							...
							<div class="col-sm-2">
								<div class="form-group">
									<label>User Longtitude</label>
									<input type="email" name="useremail" id="useremail" class="form-control" value="<?php echo isset($_REQUEST['useremail'])?$_REQUEST['useremail']:''?>" placeholder="Enter user Longtitude">
								</div>
							</div>
							<div class="col-sm-2">
								<div class="form-group">
									<label>User Lattitude</label>
									<input type="tel" name="userphone" id="userphone" class="form-control" value="<?php echo isset($_REQUEST['userphone'])?$_REQUEST['userphone']:''?>" placeholder="Enter user Lattitude">
								</div>
							</div>
							<div class="col-sm-4">
			...
			<table class="table table-striped table-bordered">
				<thead>
					<tr class="bg-primary text-white">
						<th>Sr#</th>
						<th>User Name</th>
						<th>User Longtitude</th>
						<th>Longtitude</th>
						<th>User Lattitude</th>
